...
const LightningProjectile = require("../Projectile/LightningProjectile");

class Lightning extends Mobile {
  constructor() {
    super();
    this.name       = 'Lightning';
    this.file       = 'Lightning';
    ...
    this.projectile = LightningProjectile;
  }
}

module.exports = new Lightning();