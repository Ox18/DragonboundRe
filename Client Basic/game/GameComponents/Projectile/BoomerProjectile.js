...
class BoomerProjectile {
  getS1(stime = 0) {
    return [{
      data: {
        img: BULLETS.BOOMER12,
        exp: EXPLODE.BOOMER12,
        stime: stime,
  ...
  getSS(stime = 0) {
    return [{
      data: {
        img: BULLETS.BOOMERSS,
        exp: EXPLODE.BOOMERSS,
        stime: stime,
        hole: helper.Pivot(30, 40)
      },
      type: {
...
const boomerProjectile = new BoomerProjectile();
module.exports = boomerProjectile;