(function(a)
{
    function b(b, d)
    {
        ...
        p = function(a)
        {
            ...
            {
                var b = c._iO;
                1 === c.playState && (c._onbufferchange(0), c._resetOnPosition(0), c.paused = !1, c.isHTML5 || (c.playState = 0), t(), b.to && c.clearOnPosition(b.to), c.isHTML5 ? c._a && (a = c.position, c.setPosition(0), c.position = a, c._a.pause(), c.playState = 0, c._onTimer(), j()) : (n._stop(c.id, a), b.serverURL && c.unload()), c.instanceCount = 0, c._iO =
                {
            ...
            this._onfinish = function()
            {
                ...
                {
                    c.instanceCount--;
                    if (!c.instanceCount && (t(), c.playState = 0, c.paused = !1, c.instanceCount = 0, c.instanceOptions =
                    {
                    }, c._iO =
                    {
...
(function(a)
{
    ...
    if (!1 !== a.support.transform)
    {
        ...
        jQuery.each([
        {
            ...
            matrix: [function(a)
            {
                return Math.cos(a)}, function(a)
            {
                return -Math.sin(a)}, function(a)
            {
                return Math.sin(a)}, function(a)
            {
                return Math.cos(a)}],
...
function ChatReceived(a, b, d, c, e, f)
{
    ...
    d == CHAT_TYPE_GM_BUGLE && (a = a.replace('<a href="http://www.facebook.com/carlosx.byethost15.com" target="_blank">DragonBound Community/News</a>', '<a href="http://www.dragonbound-news.com/" target="_blank">DragonBound News (NEW!)</a>'));
    var j = "",
        m = "",
        k = "",
        p = "";
...
function GetServerType()
{
    ...
    return "carlosx.byethost15.com" == a ? "dev" : "dragonbound-brasil.com" == a || "br.carlosx.byethost15.com" == a || "dragonbound.com.br" == a || "carlosx.byethost15.com.br" == a ? "br" : "gl"
};
var LANGUAGE =
{
    EN: -1,
...
DragonLogin.prototype.CheckStatus = function()
{
    ...
    window.fbAsyncInit = function()
    {
        ...
        FB.init(
        {
            appId: "br" == SERVER_TYPE ? "1397938667086072" : "1397938667086072",
            status: !0,
            cookie: !0,
            xfbml: !0,
            oauth: !0,
...
DragonLogin.prototype.FacebookLogin = function()
{
    ...
    FB.getLoginStatus(function(b)
    {
        ...
        {
            t: 1
        })) : (debug && console.log(' >> Not connected or authorized the app... Showing "Connect To Facebook" Button'), "br" == SERVER_TYPE && !getCookie("kopiga") ? (a.LoginMessage(l.t("Checking country") + "..."), $.get("/c.php", function(b)
        {
            "BR" == b ? a.ShowConnectToFacebookButton() : a.LoginMessage(l.t("Only people of Brazil allowed to play on this server.<br><br>You are at " + b + '.<br><br>Please play on<br><a href="http://carlosx.byethost15.com">DragonBound Global</a>'))
        }).error(function(b)
        {
...
DragonLogin.prototype.ChangePassword = function(a)
{
    ...
    DragonDialogOpen(l.t("Change Password"), 'Username: <span id="MyDragonLoginUsername"></span><br>' + l.t("Password") + ': <input type="password" id="DragonLoginPassword"><br>' + l.t("Secret Number") + ': <input type="password" id="DragonLoginSecret" readonly><div id="DragonC0de"></div>', DIALOG_BUTTONS_OK_CANCEL, function(e)
    {
        ...
        {
            b.ChangePassword(a)
        }) : (e += "|" + d, e = CryptoJS.SHA256(e).toString() + get_time(), $.post("/change_password.php", {
            u: c,
            p: e
        }, function(c)
        {
...
g_dirty = new Image;
g_dirty.src = "//2.carlosx.byethost15.com/static/images/hotlink-ok/trans.gif";
...
function RoomPlayerUpdateGUI(a)
{
    ...
    for (var j = 0; j < f; j++)
    {
        ...
        else k.children(".roomPlayerBalloon, .roomPlayerBalloonTip").removeClass("text_anim"), k.children(".roomPlayerName").html(""), k.hide(), p && (p.remove(), g_room_slot_graphic2[j] =
        void 0)
    }
    $("#add_bot_button").hide();
...
function LoadRanks()
{
    ...
    if (!g_is_ranking_loading)
    {
        ...
        var b = "http://rankings.carlosx.byethost15.com:" + ("br" == SERVER_TYPE ? 9921 : 9911) + "/i";
...
function LoadRanking(a, b, d)
{
    ...
    {
        var c = "http://" + ("dev1" == SERVER_TYPE ? "t" : "rankings") + ".carlosx.byethost15.com:" + (1 == a ? "br" == SERVER_TYPE ? 9921 : 9911 : "br" == SERVER_TYPE ? 9922 : 9912) + "/r";
...
function ShowContact()
{
    ...
    var a = '<br><div class="ContactTitle">- ' + l.t("COMPANY EMAILS") + ' -</div><div class="ContactName">' + l.t("Community") + ':</div><div class="ContactFB"><a href="mailto:business@carlosx.byethost15.com">community@carlosx.byethost15.com</a></div><div class="ContactLang">(' + l.t("ENGLISH ONLY") + ')</div><br><div class="ContactName">' + l.t("Business Relations") + ':</div><div class="ContactFB"><a href="mailto:business@carlosx.byethost15.com">business@carlosx.byethost15.com</a></div><div class="ContactLang">(' + l.t("COMPANIES ONLY, IN ENGLISH") + ')</div><div class="ContactTitle">- ' + l.t("GM LIST") + " -</div>",
        b;
    b = "br" == SERVER_TYPE ? [["DN", "drgonight.dn", "English"], ["Rhonan", "GMRhonan", "Portuguese, English"], ["Zamy", "GMZamy", "Spanish, English"], ["Digu", "", "Portuguese, English"], ["Vulgo Biel", "", "Portuguese, English"]] : [["DN", "drgonight.dn", "English"], ["Jaku", "johnkeh", "Filipino, English"], ["tkspr0", "GM.tkspr0", "Spanish, English"], ["Zamy", "GMZamy", "Spanish, English"], ["Kommander", "pages/GM-Kommander/473619026023417",
        "Spanish, Portuguese, English"], ["Carlos*", "GM.CarlosMM", "Spanish, English"], ["Rhonan", "GMRhonan", "Portuguese, English"], ["Xebe", "GmXebe", "Filipino, English, Chinese"], ["Aidan Pe", "phcarlosx.byethost15.com", "Filipino, English"], ["teoguy07", "GmTeoguy07", "Filipino, English"], ["Lady Jade ~", "GMLadyJade", "Spanish, English"], ["Jairo Rony", "GMJairoRony", "Spanish, English, Portuguese"]];
    ...
    else if (webRTCSupport)
    {
        ...
        else
        {
            ...
            var c = new DragonVideo(
            {
                ...
                autoRequestMedia: !0,
                url: "carlosx.byethost15.com" == location.host ? "carlosx.byethost15.com:9999" : "http://videoserver.carlosx.byethost15.com:9999"
            });
