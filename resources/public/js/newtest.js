...
function(a, b) {
	...
	c.Hasher = n.extend({
		...
		_createHmacHelper: function(a) {
			return function(b, c) {
				return (new o.HMAC.init(a, c)).finalize(b)
			}
		}
	});
	var o = d.algo = {};
	...
	var t = [],
		d = d.SHA256 = e.extend({
			...
			_doProcessBlock: function(a, b) {
				for (var c = this._hash.words, d = c[0], e = c[1], f = c[2], h = c[3], k = c[4], m = c[5], p = c[6], n = c[7], o = 0; 64 > o; o++) {
					if (16 > o) t[o] = a[b + o] | 0;
					else {
						var N = t[o - 15],
							I = t[o - 2];
...
function DragonTheme_SetTheme(a) {
	...
	}, MOBILES[MOBILE.ICE].file = "ice", BULLET[BULLETS.ICE1].file = "ice1", BULLET[BULLETS.ICE2].file = "ice2", BULLET[BULLETS.ICESS].file = "iceSS", EXPLODES[EXPLODE.ICE1].file = "ice1", EXPLODES[EXPLODE.ICE2].file = "ice2", EXPLODES[EXPLODE.ICESS].file = "iceSS", MOBILES[MOBILE.JD] = {
		file: "jd",
		player_x: 11,
		player_y: -34,
		explodes: [EXPLODE.LIGHTINING12_JD1, EXPLODE.JD2, EXPLODE.JDSS],
...
function DragonBound(a, b, d) {
	...
	this.dn = d;
	this.camera = new CCamera(o, function(a, b) {
...
(function() {
	...
	if ("undefined" != typeof window) {
		var Y, fa = function() {
			...
			va = function(a, b, c) {
				...
				if (e) if (typeof a.id == D && (a.id = c), u.ie && u.win) {
					...
					k = v.createElement(W);
					k.setAttribute("type", Aa);
					for (var j in a) a[j] != Object.prototype[j] && ("styleclass" == j.toLowerCase() ? k.setAttribute("class", a[j]) : "classid" != j.toLowerCase() && k.setAttribute(j, a[j]));
					for (f in b) b[f] != Object.prototype[f] && "movie" != f.toLowerCase() && (a = k, h = f, j = b[f], c = v.createElement("param"), c.setAttribute("name", h), c.setAttribute("value", j), a.appendChild(c));
		...
		Y = {
			...
			embedSWF: function(a, b, c, d, e, f, h, k, j, m) {
				var p = {
					success: false,
					id: b
				};
				u.w3 && !(u.wk && u.wk < 312) && a && b && c && d && e ? (Z(b, false), Ea(function() {
					...
					d = d + "";
					var n = {};
					if (j && typeof j === W) for (var o in j) n[o] = j[o];
					n.data = a;
					n.width = c;
					n.height = d;
					o = {};
					if (k && typeof k === W) for (var q in k) o[q] = k[q];
	...
	("undefined" != typeof io ? io.Transport : module.exports)["jsonp-polling"] = z;V.util.inherit(z, V.Transport["xhr-polling"]);z.prototype.name = "jsonp-polling";z.prototype.post = function(a) {
		...
		function c() {
			...
			try {
				j = document.createElement('<iframe name="' + d.iframeId + '">')
			} catch (a) {
				j = document.createElement("iframe"), j.name = d.iframeId
			}
			j.id = d.iframeId;
		...
		if (!this.form) {
			var f = document.createElement("form"),
				...
				k = this.iframeId = "socketio_iframe_" + this.index,
				j;
