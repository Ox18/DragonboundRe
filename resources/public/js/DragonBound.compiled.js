...

        {
...

            {
                ...
                for (a in K)
                    if (K.hasOwnProperty(a))
                        for (b = K[a].length - 1; 0 <= b; b--) K[a][b].fired = !1;
...

            {
...

                {
                    ...
                    1 === c.playState && (c._onbufferchange(0), c._resetOnPosition(0), c.paused = !1, c.isHTML5 || (c.playState = 0), u(), b.to && c.clearOnPosition(b.to), c.isHTML5 ? c._a && (a = c.position, c.setPosition(0), c.position = a, c._a.pause(), c.playState = 0, c._onTimer(), j()) : (n._stop(c.id, a), b.serverURL && c.unload()), c.instanceCount = 0, c._iO =
...

                {
                    ...
                    for (b = 0; b < o.length; b++)
                        if (a === o[b].position && (!c || c === o[b].method)) o[b].fired && za--, o.splice(b, 1)
...

                {
                    ...
                    for (a -= 1; 0 <= a; a--)
                        if (b = o[a], !b.fired && c.position >= b.position) b.fired = !0, za++, b.method.apply(b.scope, [b.position]);
...

                {
                    ...
                    for (c -= 1; 0 <= c; c--)
                        if (b = o[c], b.fired && a <= b.position) b.fired = !1, za--;
...

                {
                    ...
                    if (b)
                        for (a in b)
                            if (b.hasOwnProperty(a)) c.onPosition(parseInt(a, 10), b[a])
...

                {
                    ...
                    if (b)
                        for (a in b) b.hasOwnProperty(a) && c.clearOnPosition(parseInt(a, 10))
...

                {
...

                    {
                        ...
                        if (!c.instanceCount && (u(), c.playState = 0, c.paused = !1, c.instanceCount = 0, c.instanceOptions =
...

            {
                ...
                for (c in a)
                    if (a.hasOwnProperty(c))
                        if ("object" !== typeof a[c] || null === a[c] || a[c] instanceof Array) e && "undefined" !== typeof fa[b] ? h[b][c] = a[c] : "undefined" !== typeof f[c] ? (h.setupOptions[c] = a[c], h[c] = a[c]) : "undefined" === typeof fa[c] ? (ia(T("undefined" === typeof h[c] ? "setupUndef" : "setupError", c), 2), d = !1) : h[c] instanceof Function ? h[c].apply(h, a[c] instanceof Array ? a[c] : [a[c]]) : h[c] = a[c];
...

            {
...

                {
...

                    {
                        ...
                        for (e = b.length; d < e && !f; d++)
                            if (h.html5[b[d]] || c.canPlayType(b[d]).match(h.html5Test)) f = !0, h.html5[b[d]] = !0, h.flash[b[d]] = !!b[d].match(Ua);
                ...
                for (b in f)
                    if (f.hasOwnProperty(b) && (d = "audio/" + b, e[b] = a(f[b].type), e[d] = e[b], b.match(Ua) ? (h.flash[b] = !0, h.flash[d] = !0) : (h.flash[b] = !1, h.flash[d] = !1), f[b] && f[b].related))
                        for (d = f[b].related.length - 1; 0 <= d; d--) e["audio/" + f[b].related[d]] = e[b], h.html5[f[b].related[d]] = e[b], h.flash[f[b].related[d]] = e[b];
...

            {
...

                {
                    ...
                    for (e = d.length; a < e; a++)
                        if (d[a].scope ? d[a].method.apply(d[a].scope, b) : d[a].method.apply(this, b), !f) d[a].fired = !0
...

            {
                ...
                if (h.useHTML5Audio && h.hasHTML5)
                    for (b in c)
                        if (c.hasOwnProperty(b) && (c[b].required && !h.html5.canPlayType(c[b].type) || h.preferFlash && (h.flash[b] || h.flash[c[b].type]))) a = !0;
...

            {
                ...
                for (c in a)
                    if (a.hasOwnProperty(c) && ("mp3" === c || "mp4" === c))
                        if (h.html5[c] = !1, a[c] && a[c].related)
                            for (b = a[c].related.length - 1; 0 <= b; b--) h.html5[a[c].related[b]] = !1
...

            {
                ...
                if (f = Ga())
                    if (h.oMC = p(h.movieID) || q.createElement("div"), h.oMC.id) P = h.oMC.className, h.oMC.className = (P ? P + " " : "movieContainer") + (k ? " " + k : ""), h.oMC.appendChild(d), ea && (w = h.oMC.appendChild(q.createElement("div")), w.className = "sm2-object-box", w.innerHTML = j), Q = !0;
...

                {
                    ...
                    if (!h.debugFlash)
                        for (P in k) k.hasOwnProperty(P) && (h.oMC.style[P] = k[P]);
...

            {
                ...
                if (h.useHTML5Audio && h.hasHTML5)
                    for (a in h.audioFormats) h.audioFormats.hasOwnProperty(a) && b.push(a + ": " + h.html5[a] + (!h.html5[a] && X && h.flash[a] ? " (using flash)" : h.preferFlash && h.flash[a] && X ? " (preferring flash)" : !h.html5[a] ? " (" + (h.audioFormats[a].required ? "required, " : "") + "and no flash support)" : ""))
...
(function(a)

    {
...

        {
            ...
            h && (8 > o && (f[o] = m(a.pow(k, 0.5))), j[o] = m(a.pow(k, 1 / 3)), o++);
            k++
...

{
    ...
    for (var a in DragonThemeDefaultBR)
        if (0 == a.indexOf("map") && -1 == a.indexOf("_name") || 0 == a.indexOf("ranks")) DragonThemeInUse[a] = DragonThemeDefaultBR[a];
...

{
...

    {
...

        {
            ...
            if (a.damages)
                for (f = 0; f < a.damages.length; f++) b = e.GetPlayerByPlayerNumber(a.damages[f].n), a.damages[f].hp && b.ChangeHPShield(a.damages[f].hp, a.damages[f].shield ? a.damages[f].shield : 0, d, !0), void 0 != a.damages[f].movex && b.MoveTo(a.damages[f].movex, void 0 != a.damages[f].movey ? a.damages[f].movey : b.y, void 0, !1), a.damages[f].rd && b.SetReducedDefence(a.damages[f].rd);
...

{
    ...
    for (d = 0; d < a.length; d++)
        for (b = 0; b < this.players.length; b++) a[d][PLAYER_INDEX_USER_ID] == this.players[b].user_id && (this.players[b].mark = !0);
    ...
    $.get("/my_username", function(a)

        {
            ...
            2 != a.length ? DragonDialogOpen("Sorry :(", "Please re-login before changing password.", DIALOG_BUTTONS_OK, function()
                ...
                }) : (c = a[0], setCookie("csrftoken", a[1]), $("#MyDragonLoginUsername").html(a[0]))
...

{
    ...
    "gl" == SERVER_TYPE ? (b = "localhost:3000", d = 80) : "br" == SERVER_TYPE ? (b = "localhost:3000", d = 9100) : (b = "localhost:3000", d = 80);
...

{
    ...
    for (b = 0; b < f; b++)
        for (a = 0; a < e; a++) d.push(0 != c[4 * (b * e + a) + 3]);
...

{
    ...
    for (b = 0; b < f; b++)
        for (a = 0; a < e; a++) j = 4 * (b * e + a), d.push(!(0 == c[j + 3] || 255 == c[j] && 255 == c[j + 1] && 255 == c[j + 2]));
...

{
    ...
    for (e = 0; e < m; e++)
        for (c = 0; c < j; c++) k[4 * (e * j + c) + 3] = a[f] == o ? 255 : 0, f++;
    ...
    if (d)
        for (e = 0; e < m; e++)
            for (c = 0; c < j; c++)
                if (k[4 * (e * j + c) + 3])
                    for (f = 1; 10 >= f; f++)
                        if (!k[4 * (e * j + (c - f)) + 3] || !k[4 * (e * j + (c + f)) + 3] || !k[4 * ((e - f) * j + c) + 3] || !k[4 * ((e + f) * j + c) + 3] || !k[4 * ((e + f) * j + (c + f)) + 3] || !k[4 * ((e - f) * j + (c - f)) + 3] || !k[4 * ((e + f) * j + (c - f)) + 3] || !k[4 * ((e - f) * j + (c + f)) + 3])
...

{
    ...
    for (var c = d, e = 1, f = d, j = 1, m = 1; 9 >= m; m++)
        if (d = this.GetUnder(a - m, b - 10, 20), void 0 != d && (c += d, e++), d = this.GetUnder(a + m, b - 10, 20), void 0 != d) f += d, j++;
...

{
...

    {
        ...
        for (d = b - c - 10; d < b; d++)
            if (f = e - a, j = d - b, m = f * f / k + j * j / o, !p && 1.2 > m)
...

{
    ...
    if (!(0 > a || a >= this.w))
        if (0 > b && (b = 0), d >= this.h && (d = this.h - 1), !(d < b))
            for (var c = this.w, e = b; e <= d; e++) b = 4 * (e * c + a), this.imageData.data[b + 3] = 0
...

{
    ...
    if (!(0 > a || a >= this.w))
        if (0 > b && (b = 0), d >= this.h && (d = this.h - 1), !(d < b))
            for (var c = this.w, e = b; e <= d; e++) b = 4 * (e * c + a), this.imageData.data[b] /= 2, this.imageData.data[b + 1] /= 2, this.imageData.data[b + 2] /= 2
...

{
    ...
    if (this.is_alive)
        if (void 0 != d && this.look != d && (this.look = d, this.divMobile.css("scaleX", d == PLAYER_LOOK_LEFT ? 1 : -1)), this.x = a, this.y = b, c) this.divPlayer.stop(!0).css(
...

{
    ...
    for (b = 0; b < c; b++)
        if ((d = g_room_players_slots[b]) && d.user_id == a) return b
...

{
    ...
    for (d = 0; d < e; d++)
        if (c = g_room_players_slots[d]) c.is_master = c.user_id == a;
...

{
    ...
    for (var c, e = g_room_players_slots.length, f = 0; f < e; f++)
        if ((c = g_room_players_slots[f]) && (-1 == a || c.user_id == a)) c.mobile = b, g_room_slot_graphic2[f].change_mobile(b), c.user_id == d.user_id && (d.mobile = b, $("#mobile_info").removeClass().addClass("mobile_info" + b))
...

{
    ...
    for (var j = f.getContext("2d"), m = j.getImageData(0, 0, c, e), k = m.data, o = "string" == typeof a ? "1" : !0, h = 0; h < e; h++)
        for (var n = 0; n < c; n++)
...

{
    ...
    if (!(1 != a && 2 != a) && ($(".ranking_btn").removeClass("selected"), $("#ranking_btn_type" + a).addClass("selected"), !g_is_ranking_loading))
        if (isNaN(b) || (b = b - b % RANKING_PAGE_SIZE + 1), rankings_cache[a][b] && get_time() < rankings_cache[a][b].x) debug && console.log("[DragonRankings] From Cache:", b), DragonRankings_BuildPage(rankings_cache[a][b].d, a, d, b);
...

{
...

    {
...

        {
            ...
            if (n)
                if (n = new Date(n) - new Date, n >= MS_IN_1_DAY) x = Math.floor(n / MS_IN_1_DAY) + 1 + " Days";
...

            {
...

                {
...

                    {
                        ...
                        return n.className = "alertify alertify-" + c + " " + a,
...

                    {
                        ...
                        return "function" == typeof this.init && (this.init(), k()),
                        B.push(
...

    {
...

        {
            ...
            for (var b =
                    ...
                    }, a = a.split("&"), c = 0, d = a.length, e; c < d; ++c) e = a[c].split("="), e[0] && (b[e[0]] = e[1]);
        ...
        ("undefined" != typeof io ? io : module.exports).EventEmitter = m;
...

        {
            ...
            return this.$events || (this.$events =
                ...
                }), this.$events[a] ? n.util.isArray(this.$events[a]) ? this.$events[a].push(b) : this.$events[a] = [this.$events[a], b] : this.$events[a] = b, this
...

        {
...

            {
...

                {
                    ...
                    for (var d = -1, e = 0, f = c.length; e < f; e++)
...

        {
            ...
            return this.$events || (this.$events =
                ...
                }), this.$events[a] || (this.$events[a] = []), n.util.isArray(this.$events[a]) || (this.$events[a] = [this.$events[a]]), this.$events[a]
        ...
        ("undefined" != typeof io ? io : module.exports).Transport = m;
        B.util.mixin(m, B.EventEmitter);
        m.prototype.heartbeats = function()
...

        {
            ...
            if ("" !== a && (a = B.parser.decodePayload(a)) && a.length)
                for (var b = 0, c = a.length; b < c; b++) this.onPacket(a[b]);
        ...
        ("undefined" != typeof io ? io : module.exports).Socket = m;
        s.util.mixin(m, s.EventEmitter);
...

        {
            ...
            for (var a = a || this.transports, b = 0, c; c = a[b]; b++)
                if (s.Transport[c] && s.Transport[c].check(this) && (!this.isXDomain() || s.Transport[c].xdomainCheck(this))) return new s.Transport[c](this, this.sessionid);
        ...
        ("undefined" != typeof io ? io : module.exports).SocketNamespace = m;
        Q.util.mixin(m, Q.EventEmitter);
        m.prototype.$emit = Q.EventEmitter.prototype.emit;
        m.prototype.of =
        ...
        ("undefined" != typeof io ? io.Transport : module.exports).websocket = m;
        M.util.inherit(m, M.Transport);
        ...
        ("undefined" != typeof io ? io.Transport : module.exports).flashsocket = C;
        I.util.inherit(C, I.Transport.websocket);
...

        {
...

            {
...

                {
...

                    {
                        ...
                        if (f)
                            if (wa(aa[b].swfVersion) && !(t.wk && 312 > t.wk)) Z(c, !0), d && (e.success = !0, e.ref = oa(c), d(e));
...

                        {
                            ...
                            for (var h =
                                    ...
                                    }, f = f.getElementsByTagName("param"), k = f.length, j = 0; j < k; j++) "movie" != f[j].getAttribute("name").toLowerCase() && (h[f[j].getAttribute("name")] = f[j].getAttribute("value"));
...

            {
                ...
                if (e)
                    if (typeof a.id == D && (a.id = c), t.ie && t.win)
...

                    {
                        ...
                        t.w3 && !(t.wk && t.wk < 312) && a && b && c && d && e ? (Z(b, false), Ea(function()

                            {
                                ...
                                if (h && typeof h === W)
                                    for (var q in h) typeof p.flashvars != D ? p.flashvars = p.flashvars + ("&" + q + "=" + h[q]) : p.flashvars = q + "=" + h[q];
...

                    {
...

                        {
                            ...
                            for (var b = b.split("&"), c = 0; c < b.length; c++)
                                if (b[c].substring(0, b[c].indexOf("=")) == a) return ta(b[c].substring(b[c].indexOf("=") + 1))
        ...
        ("undefined" != typeof io ? io.Transport : module.exports).XHR = J;
        H.util.inherit(J, H.Transport);
        ...
        ("undefined" != typeof io ? io.Transport : module.exports).htmlfile = z;
        ca.util.inherit(z, ca.Transport.XHR);
        z.prototype.name = "htmlfile";
        ...
        ("undefined" != typeof io ? io.Transport : module.exports)["xhr-polling"] = z;
        da.util.inherit(z, da.Transport.XHR);
        da.util.merge(z, da.Transport.XHR);
        z.prototype.name = "xhr-polling";
        z.prototype.heartbeats =
        ...
        ("undefined" != typeof io ? io.Transport : module.exports)["jsonp-polling"] = z;
        V.util.inherit(z, V.Transport["xhr-polling"]);
        z.prototype.name = "jsonp-polling";
        z.prototype.post = function(a)
...
(function()

    {
...

        {
            ...
            for (b in this.callbacks)
                if (c = b.split("*"), "*" === b || 2 === c.length && a.slice(0, c[1].length) === c[1]) d = d.concat(this.callbacks[b]);
